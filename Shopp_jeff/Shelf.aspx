<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.master" CodeFile="Shelf.aspx.cs" Inherits="shopp" %>


<asp:Content ID="Shelf" ContentPlaceHolderID="MainContent" runat="server" onload="Shelf_Load">
    ...
    <div class="innerf-pages section py-5" runat="server">
        <div class="container ">
            <div class="row my-sm-5">
                    ...
                    <form runat="server">
                        ...
                        <div class="grid images_3_of_2">
                            <div class="flexslider">
                                <ul class="slides">
                                    <li data-thumb="<%=thumb_image_li1%>">
                                        <div class="thumb-image" runat="server">
                                            <asp:ImageButton ID="shelf_img_1" runat="server" data-imagezoom="true" CssClass="img-fluid" ImageUrl="images/上傳.png" />
                                        </div>
                                    </li>
                                    <li data-thumb="<%=thumb_image_li2%>" >
                                        <div class="thumb-image" runat="server">
                                            <asp:ImageButton ID="shelf_img_2" runat="server" data-imagezoom="true" CssClass="img-fluid" ImageUrl="images/上傳.png"  />
                                        </div>
                                    </li>
                                    <li data-thumb="<%=thumb_image_li3%>">
                                        <div class="thumb-image" runat="server">
                                           <asp:ImageButton ID="shelf_img_3" runat="server" data-imagezoom="true" CssClass="img-fluid" ImageUrl="images/上傳.png" />
                                        </div>
                                    </li>
                                </ul>
                ...
                <div class="col-lg-8 mt-lg-0 mt-5 single-right-left simpleCart_shelfItem">
                    ...
                    <div class="desc_single">
                        <h5>Description</h5>
                        <p>
                            Pellentesque quis orci sapien. Phasellus at pfero in nunc egestas tincidunt. In dictum arcu purus, ultricies
                        tincidunt urna vehicula at. Aenean iaculis urna nec pfero scelerisque, ac ullamcorper neque porta.
                        </p>
                    </div>
